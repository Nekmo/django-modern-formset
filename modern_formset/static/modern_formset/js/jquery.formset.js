...
function formIsDirty(form) {
    // https://github.com/darklow/django-suit/blob/develop/suit/static/suit/js/suit-form-confirm.js
    if(form.elements === undefined){
        form.elements = $(form).find('select, input')
    }
...
(function($) {
    ...
    */
    var Formset = function(el, options) {
        ...
        this.$formset.on('change', function(){
            // Add a empty
    ...
    */
    ...
    Formset.prototype.hasEmpty = function() {
        var hasEmpty = false;
        var _this = this;
